...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subOdom = nh.subscribe<nav_msgs::Odometry> ("/lio_sam/mapping/odometry", 5, odomHandler);
  ...
  ros::Publisher pubSpeed = nh.advertise<geometry_msgs::Twist> ("/stickbug/drivebase/autonomous_driving/cmd_vel", 5);
  geometry_msgs::TwistStamped cmd_vel;
  cmd_vel.header.frame_id = "drivebase/base_footprint";
